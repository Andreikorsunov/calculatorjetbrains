...
function selectOptionChange2(event){
    ...
    if(event.target.value==="gekt"){
        vastus4.innerHTML=calculate(inputValue,gekt) + " гектар";
    }
    else if(event.target.value==="km2"){
        vastus4.innerHTML=calculate(inputValue,km2) + " километров";
    }
    else if(event.target.value==="m2"){
        vastus4.innerHTML=calculate(inputValue,m2) + " метров";
    }
    else if(event.target.value==="sm2"){
        vastus4.innerHTML=calculate(inputValue,sm2) + " сантиметров";
    }
    else if(event.target.value==="mm2"){
        vastus4.innerHTML=calculate(inputValue,mm2) + " миллиметров";
    }
}
